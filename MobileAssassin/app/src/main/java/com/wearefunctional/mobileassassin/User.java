...
/**
 * Created by MatteoTanaka on 11/14/15.
 */
...
//    private String mLastUpdateTime;
    ...
    public User (/*String Username, String displayName, String password*/) {
        ...
        /* setting the basic User information */
...
//    }
    ...
    public boolean getTimeStamp(){ return timeStamp; }
    ...
    /* Methods that allow for location updates */
//    public Location getCurrentLocation() { return mCurrentLocation; }
//
//    public boolean compareLocation() {
//        double playerLong = mCurrentLocation.getLongitude();
//        double playerLat = mCurrentLocation.getLatitude();
//        double targetLong = target.getCurrentLocation().getLongitude();
//        double targetLat = target.getCurrentLocation().getLatitude();

        /* converts degrees to kilometer distance from meridians then to feet */
//        playerLong *= (10000/90)*(3280.4);
//        playerLat *= (10000/90)*(3280.4);
//        targetLong *= (10000/90)*(3280.4);
//        targetLat *= (10000/90)*(3280.4);
//        double playerX = 2.0904*Math.pow(10.0,7.0)*Math.cos(playerLat)*Math.cos(playerLong);
//        double playerY = 2.0904*Math.pow(10.0,7.0)*Math.cos(playerLat)*Math.sin(playerLong);
//
//        double targetX = 2.0904*Math.pow(10.0,7.0)*Math.cos(targetLat)*Math.cos(targetLong);
//        double targetY = 2.0904*Math.pow(10.0,7.0)*Math.cos(targetLat)*Math.sin(targetLong);
//
//        double distance = Math.hypot(playerX-targetX, playerY-targetY);
//
//        if (distance <= 25.0) {
//            return true;
//        }
...
// the nation returns to business as usual. And there will be neither rest nor tranquility in
// America until the Negro is granted his citizenship rights. The whirlwinds of revolt will continue
...
// Some of you have come fresh from narrow jail cells. And some of you have come from areas where
// your quest -- quest for freedom left you battered by the storms of persecution and staggered by
// the winds of police brutality. You have been the veterans of creative suffering. Continue to work
