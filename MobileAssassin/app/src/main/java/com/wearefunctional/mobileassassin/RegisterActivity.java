...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNameView = (AutoCompleteTextView) findViewById(R.id.displayname);
...
//                        RegisterActivity.this.startActivity(new Intent(RegisterActivity.this, LoginActivity.class));
     ...
     */
    private boolean attemptRegister() throws UnsupportedEncodingException, NoSuchAlgorithmException {
        if (mAuthTask != null) {
            return false;
        }
        ...
        //call client manager methods
        if(cancel){
            focusView.requestFocus();
            return false;
        }
        else{
            //create the user using client manager!
            System.out.println(email);
            System.out.println(displayName);
            System.out.println(password);
            System.out.println(SHAHash);
            cm.createUserInDB(email, displayName, SHAHash, false);
