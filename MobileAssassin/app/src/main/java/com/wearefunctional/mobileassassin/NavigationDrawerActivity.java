...
//    Vector<Game> playersGames;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cm = new ClientManager("https://mobileassassin.firebaseio.com/users");
...
//        playersGames = cm.getGames();

        //your name
       // thisName = you.userName;

        players = cm.getGames().elementAt(0).getPlayerNames();
